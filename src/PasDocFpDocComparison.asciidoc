...
+
link:index[PasDoc] has an output called htmlhelp, while fpdoc has chm output, although I didn't compare them personally. link:Home[PasDoc] also has link:SimpleXmlOutput[simplexml] output, and latex2rtf output.
+
